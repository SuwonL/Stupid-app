...
const PROJECT_STRUCTURE = {
  frontend: {
    ...
    components: ['calendar/CalendarGrid', 'calendar/DatePickerField', 'calendar/holidays', 'ProjectInfoModal'],
  ...
  backend: {
    ...
    web: 'RecipeController (/api/ingredients, /api/recipes/recommend, /api/recipes/{id}/detail, /api/youtube-quota, /api/youtube/{videoId}/recipe-steps)',
    services: ['RecipeRecommendService', 'RecipeDetailService', 'YouTubeService', 'YoutubeTranscriptService', 'YoutubeQuotaTracker', 'SpoonacularService'],
