...
const PROJECT_INDEX = [
  ...
  { id: 'stocks', name: '주식 추천', path: '/stocks', desc: '실시간 추천, 주식현황, 오늘의 주식 지식 하위 메뉴' },
]
...
const PROJECT_STRUCTURE = {
  frontend: {
    ...
    pages: ['FridgePage (냉장고 메뉴)', 'CalendarPage (자동 달력)', 'StockPage/StockRecommendationPage (주식 추천)'],
    ...
    api: 'api.js + services/recommendationService, services/evaluationService, services/stockInfoService (공식 데이터 검증 + AI 매수 판단)',
  },
  backend: {
    stack: 'Spring Boot, JDK 17, H2',
    entry: 'FridgeMenuApplication',
    web: 'RecipeController (/api/ingredients, /api/recipes/recommend, /api/recipes/{id}/detail), StockController (/api/stocks/*)',
    services: ['RecipeRecommendService', 'RecipeDetailService', 'YouTubeService', 'YoutubeTranscriptService', 'YoutubeQuotaTracker', 'SpoonacularService', 'StockMarketService', 'StockAiAnalysisService'],
