...
const PROJECT_INDEX = [
  ...
  { id: 'memes', name: '인스타 밈', path: '/memes', desc: 'Giphy 실시간 트렌딩 밈 10가지, 클릭 시 관련 인기 영상' },
]
...
const PROJECT_STRUCTURE = {
  frontend: {
    ...
    pages: ['FridgePage (냉장고 메뉴)', 'CalendarPage (자동 달력)', 'StockPage/StockRecommendationPage (주식 추천)', 'MemePage (인스타 밈)'],
